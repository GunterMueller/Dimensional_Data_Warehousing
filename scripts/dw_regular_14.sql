...
UPDATE sales_order_fact a, source.sales_order b, allocate_date_dim c, order_dim g 
SET 
...
UPDATE sales_order_fact a, source.sales_order b, packing_date_dim d, order_dim g 
SET 
...
UPDATE sales_order_fact a, source.sales_order b, ship_date_dim e, order_dim g 
SET 
...
UPDATE sales_order_fact a, source.sales_order b, receive_date_dim f, order_dim g 
SET 
